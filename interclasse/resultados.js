...
async function carregarResultados() {
    try {
        ...
        linhas.forEach((linha, index) => {
            ...
            const golsPerdedorf = colunas[4] !== "" ? colunas[4] : 0;
            const golsVencedorf = colunas[5] !== "" ? colunas[5] : 0;
            const mostrarPlacarF = colunas[4] !== "" || colunas[5] !== "";
            ...
            <div class="card-placar">
                <div class="confronto">
                    ...
                    <div class="placares">
                        ...
                        ${mostrarPlacarF ? `
                           <div class="placar-f">${golsVencedorf} - ${golsPerdedorf}</div>
                        ` : ''}
                    </div>
